...
public class Joystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    protected void ClampJoystick()
    {
		...
		if (joystickMode == JoystickMode.SemiBottom)
			inputVector = new Vector2(inputVector.x, (inputVector.y > -0.5f)? 0:-1);
	}
}

public enum JoystickMode { AllAxis, Horizontal, Vertical, SemiBottom}
